...
| `pub fn set_promotion(&mut self, piece: &str) -> Option<Gamestate>`         | If the current game state is [`GameState::Promoting`], promote the pawn that can be promoted to `piece`.  Otherwise, return [`None`].                                                              | 
...
| `pub fn to_fen(&self) -> String;`                                                 | Return the current game board as a FEN string for easy test assertions.                                                                                                                            |
